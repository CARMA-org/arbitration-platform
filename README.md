...
```text
arbitration-platform % ./run.sh --full                                        
Compiling...
Running...
...
Simulation Metrics Summary:
  Duration: 14.99 seconds (275 ticks)
...
## Latest `GroupingPolicyDemo` Output

```text
arbitration-platform % java -cp out org.carma.arbitration.GroupingPolicyDemo
╔══════════════════════════════════════════════════════════════════════════════╗
...
───────────────────────────────────────────────────────────────────────────────
  ...
  50 agents:
    Baseline: 1 groups, max=37, detection=0.34ms
    Policy:   4 groups, max=10, detection=2.16ms
    Estimated optimization speedup: 15.2x

  100 agents:
    Baseline: 1 groups, max=81, detection=0.98ms
    Policy:   9 groups, max=10, detection=9.64ms
    Estimated optimization speedup: 66.4x

  200 agents:
    Baseline: 1 groups, max=179, detection=4.23ms
    Policy:   18 groups, max=10, detection=41.15ms
...
## Latest `NonlinearUtilityDemo` Output

```text
avyaycasheekar@Avyays-MacBook-Pro arbitration-platform % java -cp out org.carma.arbitration.NonlinearUtilityDemo
══════════════════════════════════════════════════════════════════════
